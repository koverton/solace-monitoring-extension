...
//
public class SempMarshaller_r9_2_0 implements SempMarshaller<Rpc, RpcReply> {
    private static final Logger logger = LoggerFactory.getLogger(SempMarshaller_r9_2_0.class);

    public SempMarshaller_r9_2_0() throws JAXBException {
    ...
    public String toRequestXml(Rpc rpc){
        ...
        try {
            ...
            logger.error("Exception thrown marshaling soltr/8.2.0 request", e);
            e.printStackTrace();
        }
