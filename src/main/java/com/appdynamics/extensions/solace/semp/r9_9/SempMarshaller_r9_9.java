...
import com.solacesystems.semp_jaxb.r9_9.reply.RpcReply;
...
//
public class SempMarshaller_r9_9 implements SempMarshaller<Rpc, RpcReply> {
    private static final Logger logger = LoggerFactory.getLogger(SempMarshaller_r9_9.class);

    public SempMarshaller_r9_9() throws JAXBException {
    ...
    public String toRequestXml(Rpc rpc){
        ...
        try {
            ...
            logger.error("Exception thrown marshaling soltr/9.9.0.45 request", e);
            e.printStackTrace();
        }
    ...
    public RpcReply fromReplyXml(String response) {
        try {
            ...
            logger.error("Exception thrown unmarshaling soltr/9.9.0.45 reply", e);
            e.printStackTrace();
        }
        return null;
    }
