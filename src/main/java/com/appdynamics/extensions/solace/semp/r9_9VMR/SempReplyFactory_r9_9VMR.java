...
import com.solacesystems.semp_jaxb.r9_9VMR.reply.*;
...
import static com.appdynamics.extensions.solace.semp.r9_9VMR.StatsHelper.*;

public class SempReplyFactory_r9_9VMR implements SempReplyFactory<RpcReply> {
    private static final Logger logger = LoggerFactory.getLogger(SempReplyFactory_r9_9VMR.class);

    final private ServerConfigs serverConfigs;

    public SempReplyFactory_r9_9VMR(ServerConfigs serverConfigs) {
