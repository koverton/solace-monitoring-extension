...
import com.solacesystems.semp_jaxb.r9_2_0.request.ObjectFactory;
import com.solacesystems.semp_jaxb.r9_2_0.request.Rpc;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class SempRequestFactory_r9_2_0 implements SempRequestFactory<Rpc> {
    private static final Logger logger = LoggerFactory.getLogger(SempRequestFactory_r9_2_0.class);

    public SempRequestFactory_r9_2_0(ServerConfigs serverConfigs) {
