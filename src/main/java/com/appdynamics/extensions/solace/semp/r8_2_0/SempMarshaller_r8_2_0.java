...
//
public class SempMarshaller_r8_2_0 implements SempMarshaller<Rpc, RpcReply> {
    private static final Logger logger = LoggerFactory.getLogger(SempMarshaller_r8_2_0.class);

    public SempMarshaller_r8_2_0() throws JAXBException {
