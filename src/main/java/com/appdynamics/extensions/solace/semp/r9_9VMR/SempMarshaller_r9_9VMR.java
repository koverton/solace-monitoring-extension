...
//
public class SempMarshaller_r9_9VMR implements SempMarshaller<Rpc, RpcReply> {
    private static final Logger logger = LoggerFactory.getLogger(SempMarshaller_r9_9VMR.class);

    public SempMarshaller_r9_9VMR() throws JAXBException {
    ...
    public String toRequestXml(Rpc rpc){
        ...
        try {
            ...
            logger.error("Exception thrown marshaling soltr/9.9VMR request", e);
            e.printStackTrace();
        }
    ...
    public RpcReply fromReplyXml(String response) {
        try {
            ...
            logger.error("Exception thrown unmarshaling soltr/9.9VMR reply", e);
            e.printStackTrace();
        }
        return null;
    }
