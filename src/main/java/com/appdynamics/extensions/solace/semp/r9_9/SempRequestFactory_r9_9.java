...
import com.solacesystems.semp_jaxb.r9_9.request.ObjectFactory;
import com.solacesystems.semp_jaxb.r9_9.request.Rpc;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class SempRequestFactory_r9_9 implements SempRequestFactory<Rpc> {
    private static final Logger logger = LoggerFactory.getLogger(SempRequestFactory_r9_9.class);

    public SempRequestFactory_r9_9(ServerConfigs serverConfigs) {
