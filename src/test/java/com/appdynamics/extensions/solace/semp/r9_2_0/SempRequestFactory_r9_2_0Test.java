...
import com.solacesystems.semp_jaxb.r9_2_0.request.Rpc;
...
public class SempRequestFactory_r9_2_0Test {
    private static final String SEMP_VERSION = "soltr/9_2_0";
    private static SempRequestFactory_r9_2_0 factory;
    ...
    public static void setup() throws JAXBException {
        factory = new SempRequestFactory_r9_2_0(new ServerConfigs(new HashMap<>()));
