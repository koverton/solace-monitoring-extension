...
public class SempMarshaller_r9_9VMRTest
{

    private String readFile(String filename) throws Exception {
        String SEMP_VERSION = "9_9VMR";
    ...
    private static SempReplyFactory_r9_9VMR factory;
    ...
    public static void setup() throws JAXBException {
        ...
        factory = new SempReplyFactory_r9_9VMR(new ServerConfigs(exclusionsMap));
    }
