...
public class SempMarshaller_r9_9Test
{

    private String readFile(String filename) throws Exception {
        String SEMP_VERSION = "r9_9";
    ...
    private static SempReplyFactory_r9_9 factory;
    ...
    public static void setup() throws JAXBException {
        ...
        factory = new SempReplyFactory_r9_9(new ServerConfigs(exclusionsMap));
    }
