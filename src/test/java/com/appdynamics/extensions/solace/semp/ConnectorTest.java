...
public class ConnectorTest {
    ...
    public void localhostDefaultConfigsQueueListTest() throws Exception {
        ...
        String request =  marshaller.toRequestXml( factory.createQueueListRequest(sempVersion, "*", null) );
...
//    @Test
    public void localhostExtendedConfigsQueueStatsTest() throws Exception {
        ...
        String request =  marshaller.toRequestXml( factory.createQueueStatsListRequest(sempVersion, "*", null) );
        String response = connector.doPost(request);
