...
public class SempRequestFactory_r9_2_0VMRTest {
    private static final String SEMP_VERSION = "soltr/9_2_0VMR";
    private static SempRequestFactory_r9_2_0VMR factory;
    ...
    public static void setup() throws JAXBException {
        factory = new SempRequestFactory_r9_2_0VMR(new ServerConfigs(new HashMap<>()));
