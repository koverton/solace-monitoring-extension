...
public class SempRequestFactory_r8_13_0Test {
    private static final String SEMP_VERSION = "soltr/8_13_0";
    private static SempRequestFactory_r8_13_0 factory;
    ...
    public static void setup() throws JAXBException {
        factory = new SempRequestFactory_r8_13_0(new ServerConfigs(new HashMap<>()));
