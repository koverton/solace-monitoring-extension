...
public class SempRequestFactory_r9_9VMRTest {
    private static final String SEMP_VERSION = "soltr/9_9VMR";
    private static SempRequestFactory_r9_9VMR factory;
    private static SempMarshaller_r9_9VMR marshaller;

    private static String xmltag = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>";

    @BeforeClass
    public static void setup() throws JAXBException {
        factory = new SempRequestFactory_r9_9VMR(new ServerConfigs(new HashMap<>()));
        marshaller = new SempMarshaller_r9_9VMR();
    }
